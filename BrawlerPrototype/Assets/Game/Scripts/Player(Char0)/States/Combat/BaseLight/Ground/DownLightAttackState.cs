...
public class DownLightAttackState : GroundStates 
{
    private D_LightAttacks lightAttackData;
    private GameObject projectile;
    public DownLightAttackState(Player player, string animBoolName, D_LightAttacks lightAttackData) : base(player, animBoolName)
    {
