...
public class UpLightAttackState : GroundStates
{
    private D_LightAttacks lightAttackData;
    public UpLightAttackState(Player player, string animBoolName, D_LightAttacks lightAttackData) : base(player, animBoolName)
    {
    ...
    {
        base.LogicUpdate();
        player.Core.Movement.SetVelocityX(0.5f);
    }
